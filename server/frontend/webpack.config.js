...
module.exports = {
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        'Content-Security-Policy': {
          ...
          content:
            "default-src 'self' http://localhost:4000; script-src 'self' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: http://localhost:4000; connect-src 'self' http://localhost:4000"
        }
      }
    })
  ],
  ...
  devServer: {
    ...
    compress: true,
    port: 9001, // Different port from client
    hot: true,
